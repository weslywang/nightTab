export const trine = {
  ...
  background: {
    ...
    image: { url: 'https://github.com/zombieFox/iTabAssets/blob/main/images/1626365111390.jpeg?raw=true', blur: 0, grayscale: 0, scale: 100, accent: 0, opacity: 30, vignette: { opacity: 50, start: 95, end: 60 } },
