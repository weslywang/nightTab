export const umbra = {
  ...
  background: {
    ...
    image: { url: 'https://github.com/zombieFox/iTabAssets/blob/main/images/1628946282879.jpeg?raw=true', blur: 0, grayscale: 100, scale: 100, accent: 0, opacity: 20, vignette: { opacity: 31, start: 90, end: 0 } },
