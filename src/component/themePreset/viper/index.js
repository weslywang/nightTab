export const viper = {
  ...
  background: {
    ...
    image: { url: 'https://github.com/zombieFox/iTabAssets/blob/main/images/1626368964266.jpeg?raw=true', blur: 0, grayscale: 100, scale: 100, accent: 20, opacity: 22, vignette: { opacity: 0, start: 90, end: 70 } },
