export const scoria = {
  ...
  background: {
    ...
    image: { url: 'https://github.com/zombieFox/iTabAssets/blob/main/images/1626775107287.jpeg?raw=true', blur: 4, grayscale: 0, scale: 100, accent: 0, opacity: 100, vignette: { opacity: 0, start: 90, end: 70 } },
