export const hypnos = {
  ...
  background: {
    ...
    image: { url: 'https://github.com/zombieFox/iTabAssets/blob/main/images/1628356492462.jpeg?raw=true', blur: 0, grayscale: 0, scale: 100, accent: 0, opacity: 5, vignette: { opacity: 0, start: 90, end: 70 } },
